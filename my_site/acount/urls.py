...
from .views import ArticleListView,ArticleCreateView, ArticleUpdateView, ArticleDeleteView, ProfileView, Login, UsersProfile, request_author
...
urlpatterns = [
    ...
    path('profile/request_author', request_author, name='request_author' )
]